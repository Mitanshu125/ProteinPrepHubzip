...
const BMICalculator = () => {
  ...
  return (
    <div className="bmi-card-v2" id="bmi-section">
  <div className="bmi-blob bmi-blob-1" />
  <div className="bmi-blob bmi-blob-2" />
  <div className="bmi-icon-badge">⚖️</div>
      <div className="bmi-card-v2-header">
       <h2 className="bmi-card-v2-title">Check Your BMI</h2>
        <p className="bmi-card-v2-sub">Understand your weight in relation to your height</p>
      </div>
